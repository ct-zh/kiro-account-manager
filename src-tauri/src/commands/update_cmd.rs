...
const UPDATE_URL_DEFAULT: &str =
    "https://github.com/ct-zh/kiro-account-manager/releases/latest/download/latest.json";
#[cfg(target_os = "linux")]
const UPDATE_URL_DEB: &str =
    "https://github.com/ct-zh/kiro-account-manager/releases/latest/download/latest-deb.json";
#[cfg(target_os = "linux")]
const UPDATE_URL_RPM: &str =
    "https://github.com/ct-zh/kiro-account-manager/releases/latest/download/latest-rpm.json";
